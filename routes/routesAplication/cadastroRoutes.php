...
Route::middleware('autenticado')->group(function() {
    ...
    Route::get('/cadastrar-categoria', [CadastrosController::class, 'CategoriaCreate'])->name('cadastros.categorias');
    Route::post('/cadastrando-categoria', [CadastrosController::class, 'CategoriaStore'])->name('cadastros.categorias-store');
