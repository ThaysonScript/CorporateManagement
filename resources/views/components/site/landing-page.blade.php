        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item text-white h5 me-4 border border-light rounded">
              <a class="nav-link link-opacity-100" href="{{ route('autenticacao.login') }}">Entrar</a>
            </li>
            <li class="nav-item text-white h5 border border-light rounded ms-4">
              <a class="nav-link link-opacity-100" href="{{ route('autenticacao.registro') }}">Se Cadastre Agora!</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          ...
          <p>Cadastre Estoques, categorias, produtos, fornecedores e muito mais. Somente aqui você tem tudo de graça</p>
        </div>
        <div class="col-md-4">
          <div class="text-center mb-4">
          ...
          <p>A maneira a qual você utilizará este serviço não irá tomar todo o seu tempo, pelo contrário, só ganhará cada vez mais horas do seu dia.</p>
        </div>
        <div class="col-md-4">
          <div class="text-center mb-4">
          ...
          <p>Ajude sua empresa a alcançar resultados incríveis com o nosso gerenciador de negócios de ponta a ponta.</p>
        </div>
      </div>
    </div>
  </section>
